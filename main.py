...
while True:
    print('Введите 1 для шифрования и 2 для дешифрования')
    way = input()
    if way not in ['1', '2']:
...
print()
while True:
    print('Введите свой ключ для шифрования/дешифрования. Ключ должен содержать не более 16 символов.')
    key = input()
...
print('Новый файл здесь:', out_path)
input()
